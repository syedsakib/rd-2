  ...
  return (
    <React.Fragment>
      <div className="page-content">
        ...
        <Container fluid>
          {/* Render Breadcrumb */}
          <Breadcrumb title="Admin" breadcrumbItem="edit user" />
          ...
          <Row>
            <Col lg="12">
              <Card>
                <CardHeader>
                  <div className="row">
                    <div className="col-md-6 my-auto">Edit User Details</div>
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <form onSubmit={handleSubmit(onSubmitHandler)}>
                        ...
                        {suggestedRoles && prevRoles && (
                          <div className="row mt-3">
                            <div className="col-sm-12">
                              <div className="form-group">
                                <label htmlFor="city">Roles</label>
                                <ReactTags
                                  defaultTags={prevRoles}
                                  suggestionList={suggestedRoles}
