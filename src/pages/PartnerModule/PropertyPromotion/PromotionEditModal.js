...
import { editPromotion } from "../../../store/Actions/partnerAction";
...
const PromotionEditModal = ({
  ...
  useEffect(() => {
    if (itemDetail) {
      updateFormData({
        ...formData,
        promotionText: itemDetail.promotion_content,
        startDate: new Date(itemDetail.startDate),
        endDate: new Date(itemDetail.endDate),
        promotionTitle: itemDetail.promotion_title,
      });
    }
  }, [itemDetail]);
  ...
  const onSubmitHandler = async () => {
    try {
      ...
      toggleLoader(true);
      let result = await editPromotion({
        promotionText,
...
const mapDispatchToProps = { editPromotion };

export default connect(mapStateToProps, mapDispatchToProps)(PromotionEditModal);
