...
export const getAgencySalesAssignedHistory =
  (filterOption) => async (dispatch) => {
    try {
      let result = await postRequestWithAuth(
...
export const deleteSalesSchedule =
  (scheduleId, agencyId) => async (dispatch) => {
    try {
