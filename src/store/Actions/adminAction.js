...
export const getServiceListingDetails = seniorLivingType => async dispatch => {
  try {
...
export const getAllApplicants = filterData => async dispatch => {
  try {
    let result = await postRequestWithAuth("admin/getAllApplicants", filterData)
...
export const getAllTour = (pageNumber, searchText, date) => async dispatch => {
  try {
...
export const addArticle = postData => async dispatch => {
  try {
    ...
    let result = await postRequestWithAuth(`admin/addArticle`, formData, config)
    const { msg, status } = result.data
    if (status === 200) {
      toastr.success("Success", msg)
      return true
...
export const editWriter = postData => async dispatch => {
  try {
    ...
    let result = await postRequestWithAuth(`admin/editWriter`, formData, config)
    const { msg, status } = result.data
    if (status === 200) {
      toastr.success("Success", msg)
      return true
...
export const offStatusOfProperties = (id, propertyStatus) => async dispatch => {
  try {
...
export const getPendingAgencyClaimRecords = filterData => async dispatch => {
  try {
    let result = await postRequestWithAuth(
